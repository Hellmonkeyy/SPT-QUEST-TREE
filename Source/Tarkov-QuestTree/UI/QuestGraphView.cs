...
namespace QuestTree.UI
{
    ...
    internal sealed class QuestGraphView
    {
        ...
        /// third-party UI package - see UILineConnector for the same reasoning. A MonoBehaviour by
        /// necessity: it is added to the viewport GameObject so Unity's event system delivers drag
        /// and scroll to it.</summary>
